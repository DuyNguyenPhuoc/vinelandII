...
d29 = extract_page_full(29)
d30 = extract_page_full(30)

with open('table_b1_29_30.json', 'w', encoding='utf-8') as f:
    json.dump({'29': d29, '30': d30}, f, indent=2)
print('Saved to table_b1_29_30.json')
